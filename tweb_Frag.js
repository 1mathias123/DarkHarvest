//contracts addresses
const tokenAddress = 'TPpLkxGeKragRC7qpiQjjtNmf6shXWi8i9' // this is the lp token

const dhmAddress = 'TGAuyPkfBYfA8ZVEQqboaNK1iStJokgnnW' //dmh

const stakingAddress = 'TVH2TwW4xKWD5aAUBEz5gXx5G1udFwyENP'// staking
...
async function stake() {
  stakingInstance = await tronWeb.contract().at(stakingAddress)
  const amount = document.getElementById('tokenAmount').value*1000000000000000000
  const options = {
        feeLimit:100000000,
        callValue:0,
  }
